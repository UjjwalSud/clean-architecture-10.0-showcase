...
Infrastructure modules are composed in `API/src/Infrastructure/Startup.cs` (`AddInfrastructure` / `UseInfrastructure` / `MapEndpoints`), including persistence, auth, Hangfire, caching, file storage, Stripe, Jitsi, notifications, OpenAPI, health checks, and related middleware.
...
| Section | Focus |
|---------|--------|
| [Security](./Security/README.md) | HTTPS/HSTS, headers, CORS, rate limiting, exception boundary, [pipeline diagram](../assets/diagrams/request-pipeline/README.md) |
| [Authentication](./Authentication/README.md) | Session-bound JWT, refresh rotation/reuse, idle/absolute timeouts, logout |
...
| [OpenApi-NSwag](./OpenApi-NSwag/README.md) | OpenAPI document + Swagger UI |
